...
def fail(test, method, output1, output2, index):
    ...
    failed_test_out_put_my = (
        f"{TEST_FOLDER_NAME}/failed_test_output_{index+1}_method_{method}_my.txt"
    )
    failed_test_out_put_other = (
        f"{TEST_FOLDER_NAME}/failed_test_output_{index+1}_method_{method}_other_program.txt"
    )
