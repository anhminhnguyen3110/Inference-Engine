...
class Resolution(Algorithm):
    ...
    def entails(self) -> tuple[bool, list]:
        ...
        # Convert all sentences to CNF form
        ...
        while True:
            ...
            for i in range(len(list_clauses) - 1):
                for j in range(i + 1, len(list_clauses)):
                    ...
                    # Check if the empty clause is in the resolvents
                    if [] in resolvents:
                        return True, []
            ...
            # Check if all clauses in new are already in list_clauses    
